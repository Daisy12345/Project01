...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { assets: @branch.assets, branch_city: @branch.branch_city, branch_name: @branch.branch_name }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { assets: @branch.assets, branch_city: @branch.branch_city, branch_name: @branch.branch_name }
    assert_redirected_to branch_path(assigns(:branch))
  end
